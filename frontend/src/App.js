...
const AnalyzePage = lazyWithReload(() => import("@/pages/AnalyzePage"));
const DemoAnalysisPage = lazyWithReload(() => import("@/pages/DemoAnalysisPage"));
...
const RefundPage = lazyWithReload(() => import("@/pages/RefundPage"));
const CancellationPage = lazyWithReload(() => import("@/pages/CancellationPage"));
const ShippingPage = lazyWithReload(() => import("@/pages/ShippingPage"));
const ContactPage = lazyWithReload(() => import("@/pages/ContactPage"));
const BadmintonPage = lazyWithReload(() => import("@/pages/BadmintonPage"));
const TennisPage = lazyWithReload(() => import("@/pages/TennisPage"));
const TableTennisPage = lazyWithReload(() => import("@/pages/TableTennisPage"));
const PickleballPage = lazyWithReload(() => import("@/pages/PickleballPage"));
const CricketPage = lazyWithReload(() => import("@/pages/CricketPage"));
const SwimmingPage = lazyWithReload(() => import("@/pages/SwimmingPage"));
const FootballPage = lazyWithReload(() => import("@/pages/FootballPage"));
const BasketballPage = lazyWithReload(() => import("@/pages/BasketballPage"));
const GymPage = lazyWithReload(() => import("@/pages/GymPage"));
const WeightLiftingPage = lazyWithReload(() => import("@/pages/WeightLiftingPage"));
const PhysiotherapyPage = lazyWithReload(() => import("@/pages/PhysiotherapyPage"));
...
const DownloadPage = lazyWithReload(() => import("@/pages/DownloadPage"));
