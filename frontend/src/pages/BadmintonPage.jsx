...
const FAQS = [
  ...
  },
  {
    ...
    a: "You get 2 free analyses on signup, and generating training plans and browsing equipment recommendations is free. No credit card required to get started; after that, analyses come in affordable one-time packs.",
  },
];
    ...
    <div className="min-h-screen bg-zinc-950" data-testid="badminton-page">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          >
            ...
            <Button asChild size="lg" variant="outline" className="border-zinc-700 text-white hover:bg-zinc-900">
              <Link to="/badminton/equipment">Find your badminton gear</Link>
            </Button>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-zinc-900/50 border-y border-zinc-800/50">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-10">
            <EquipmentFinderCTA sport="Badminton" href="/badminton/equipment" noun="rackets" />
          </div>
        </div>
      </section>
