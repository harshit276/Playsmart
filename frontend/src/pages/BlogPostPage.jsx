...
export default function BlogPostPage() {
  ...
  useEffect(() => {
    ...
    api.get(`/blog/${slug}`)
      .then(({ data }) => {
        setPost(data);
        document.title = `${data.title} | Formanti Blog`;
  ...
  const articleStructuredData = {
    ...
    author: { "@type": "Organization", "name": "Formanti" },
    publisher: {
      "@type": "Organization",
      name: "Formanti",
      ...
      <section className="container mx-auto px-4 max-w-3xl py-12 sm:py-16">
        <div className="bg-gradient-to-br from-zinc-900 to-zinc-800/50 border border-zinc-700/30 rounded-2xl p-8 sm:p-12 text-center">
          ...
          <p className="text-zinc-400 mb-6 max-w-lg mx-auto">
            Try Formanti free and get AI-powered analysis, personalized training plans, and smart equipment recommendations.
          </p>
          <Link to="/auth"
