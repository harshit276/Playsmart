...
const FAQS = [
  {
    ...
    a: "Bat size is based on height. For example, a player 5'6\"–5'9\" usually needs a Harrow or full-size Short Handle bat, while players under 4'11\" use sizes 4–6. Pick a bat you can pick up and swing comfortably without straining. Formanti's gear finder matches a size and weight to your height and style.",
  },
  {
  ...
  },
  {
    ...
    a: "Record yourself batting in the nets from side-on with your phone, upload it to Formanti, and the AI cricket coach will break down your stance, backlift, footwork, and contact point with frame-by-frame feedback — no coach required.",
  },
  {
  ...
  {
    q: "Is the Formanti cricket app free?",
    ...
    <div className="min-h-screen bg-zinc-950" data-testid="cricket-page">
      ...
      <section className="relative pt-10 pb-14 md:py-24 px-4 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <motion.div initial="hidden" animate="visible" variants={fadeUp}>
            <Badge className="bg-blue-400/10 text-blue-400 border border-blue-400/30 mb-4 md:mb-6">
              🏏 Cricket Specialist
            </Badge>
          </motion.div>
          <motion.h1
          ...
          <motion.div initial="hidden" animate="visible" custom={3} variants={fadeUp} className="mb-8">
            <SportUploadCTA sport="cricket" label="cricket" compact />
          </motion.div>
          ...
          >
            ...
            <Button asChild size="lg" variant="outline" className="border-zinc-700 text-white hover:bg-zinc-900">
              <Link to="/cricket/equipment">Find your cricket gear</Link>
            </Button>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-zinc-400 mt-3 max-w-2xl mx-auto">
              Every tool on Formanti is tuned to the technique and demands of batting, bowling, and fielding.
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-zinc-900/50 border-y border-zinc-800/50">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-10">
            <EquipmentFinderCTA sport="Cricket" href="/cricket/equipment" noun="bats & gear" />
          </div>
        </div>
      </section>
