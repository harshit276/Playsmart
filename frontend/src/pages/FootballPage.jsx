    ...
    <div className="min-h-screen bg-zinc-950" data-testid="football-page">
      ...
      <section className="relative pt-10 pb-14 md:py-24 px-4 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <motion.div initial="hidden" animate="visible" variants={fadeUp}>
            <Badge className="bg-green-400/10 text-green-400 border border-green-400/30 mb-4 md:mb-6">
              ⚽ Football Specialist
            </Badge>
          </motion.div>
          <motion.h1
          ...
          >
            ...
            <Button asChild size="lg" variant="outline" className="border-zinc-700 text-white hover:bg-zinc-900">
              <Link to="/football/equipment">Find your football gear</Link>
            </Button>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-zinc-900/50 border-y border-zinc-800/50">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-10">
            <EquipmentFinderCTA sport="Football" href="/football/equipment" noun="boots & gear" />
          </div>
        </div>
      </section>
