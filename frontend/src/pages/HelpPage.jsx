...
export default function HelpPage() {
  ...
  useEffect(() => { document.title = "Help & Support · AthlyticAI"; }, []);
  ...
  return (
    <div className="min-h-screen bg-zinc-950 py-6 sm:py-8">
      <SEO
        title="Help & Customer Support · AthlyticAI"
        description="Contact AthlyticAI customer care. Get help with sign-in, tokens, video analysis, equipment orders, or report a bug."
      />
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
          ...
          <p className="text-zinc-300 text-sm">
            ...
            For urgent issues, email <a href="mailto:hello@athlyticai.com" className="underline text-lime-300">hello@athlyticai.com</a>.
          </p>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
          ...
          <a href="mailto:hello@athlyticai.com"
            ...
            <div>
              ...
              <p className="text-[11px] text-zinc-400">hello@athlyticai.com</p>
