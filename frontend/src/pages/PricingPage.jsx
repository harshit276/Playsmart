...
export default function PricingPage() {
  ...
  useEffect(() => { document.title = "Pricing | Formanti"; }, []);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            ...
            },
            {
              ...
              a: "Bulk discounts kick in at the Power Pack tier. For 5+ coaches or 50+ students, email support@formanti.com for custom pricing.",
            },
          ].map((item, i) => (
