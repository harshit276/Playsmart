    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <div className="container mx-auto px-4 max-w-4xl py-12 md:py-16">
        ...
        <Section title="1. Introduction">
          <p>
            Formanti ("we", "our", "us") is an AI-powered sports coaching platform. We are committed to protecting your privacy and being transparent about how we handle your data. This policy explains what information we collect, how we use it, and your rights.
          </p>
        </Section>
        ...
        <Section title="12. Contact Us">
          ...
          <p>
            <a href="mailto:support@formanti.com" className="text-lime-400 hover:text-lime-300 transition-colors font-medium">
              support@formanti.com
            </a>
          </p>
        </Section>
