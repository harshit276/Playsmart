...
const FAQS = [
  {
    ...
    a: "The most common mistakes are lifting the head too high (which sinks the hips), crossing the centreline on entry, a dropped elbow during the pull, holding your breath instead of exhaling underwater, and an over-big knee-bending kick. AthlyticAI's stroke analysis flags these directly from your video.",
  },
  {
  ...
  },
  {
    ...
    a: "Have someone film you from the side of the pool (above and, if possible, below the surface), upload the clip to AthlyticAI, and the AI swimming coach will break down your body position, catch, pull, and breathing with frame-by-frame feedback.",
  },
  {
  ...
  {
    q: "Is the AthlyticAI swimming app free?",
  ...
  return (
    <div className="min-h-screen bg-zinc-950" data-testid="swimming-page">
      <SEO
        ...
        url="https://athlyticai.com/swimming"
        structuredData={{
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-zinc-400 mt-3 max-w-2xl mx-auto">
              Every tool on AthlyticAI is tuned to stroke efficiency, body position, and the technique that makes you faster.
            </p>
          </div>
