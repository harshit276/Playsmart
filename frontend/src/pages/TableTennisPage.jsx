...
const FAQS = [
  {
    ...
    a: "Yes. Formanti's table tennis video analysis detects the ball and both players, classifies every stroke, and provides technique feedback even from a standard phone video filmed from the end of the table.",
  },
  {
    ...
    <div className="min-h-screen bg-zinc-950" data-testid="table-tennis-page">
      ...
      <section className="relative pt-10 pb-14 md:py-24 px-4 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <motion.div initial="hidden" animate="visible" variants={fadeUp}>
            <Badge className="bg-sky-400/10 text-sky-400 border border-sky-400/30 mb-4 md:mb-6">
          ...
          >
            ...
            <Button asChild size="lg" variant="outline" className="border-zinc-700 text-white hover:bg-zinc-900">
              <Link to="/table-tennis/equipment">Find your table tennis gear</Link>
            </Button>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-zinc-900/50 border-y border-zinc-800/50">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-10">
            <EquipmentFinderCTA sport="Table Tennis" href="/table-tennis/equipment" noun="blades & rubbers" />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-zinc-400">
              Example week for an intermediate looper. Formanti adapts the full plan to your level,
