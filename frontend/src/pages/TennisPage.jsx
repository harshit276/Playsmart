...
const FAQS = [
  {
    ...
    a: "Record your serve from behind the baseline or 45° side view. Upload it to Formanti and our AI tennis coach will break down trophy position, racket drop, contact point, and measure your serve speed.",
  },
  {
    q: "How fast is a professional tennis serve?",
    a: "Top ATP players regularly serve above 200 km/h; the record is around 263 km/h. Club players typically serve 120-160 km/h. Formanti's tennis video analyzer estimates your serve speed from any smartphone footage.",
  },
  {
  ...
  {
    q: "Can Formanti coach forehand and backhand technique?",
    ...
    <div className="min-h-screen bg-zinc-950" data-testid="tennis-page">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          >
            ...
            <Button asChild size="lg" variant="outline" className="border-zinc-700 text-white hover:bg-zinc-900">
              <Link to="/tennis/equipment">Find your tennis gear</Link>
            </Button>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-zinc-400 mt-3 max-w-2xl mx-auto">
              From serve speed tracking to shot-by-shot pattern analysis, Formanti is your always-on
              tennis coach.
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-zinc-900/50 border-y border-zinc-800/50">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-10">
            <EquipmentFinderCTA sport="Tennis" href="/tennis/equipment" noun="racquets" />
          </div>
        </div>
      </section>
